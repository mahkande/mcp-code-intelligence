...
This directory contains various utility scripts for development, building, and deployment of the MCP Code Intelligence project.
...
- Indexed project: Run `mcp-code-intelligence init && mcp-code-intelligence index`
...
cd /path/to/mcp-code-intelligence
python scripts/version_manager.py --show
```
...
cat src/mcp_code_intelligence/__init__.py | grep -E "(version|build)"
