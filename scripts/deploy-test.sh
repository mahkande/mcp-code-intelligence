...
pip uninstall mcp-code-intelligence -y 2>/dev/null || true
...
mcp-code-intelligence --help > /dev/null || {
...
echo "   2. Run: mcp-code-intelligence init"
echo "   3. Run: mcp-code-intelligence index"
echo "   4. Run: mcp-code-intelligence search 'some query'"
