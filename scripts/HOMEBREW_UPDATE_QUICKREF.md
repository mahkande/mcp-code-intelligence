...
```bash
curl -s https://pypi.org/pypi/mcp-code-intelligence/0.14.3/json | head -5
```

### Check Current Homebrew Formula
```bash
curl -s https://raw.githubusercontent.com/bobmatnyc/homebrew-mcp-code-intelligence/main/Formula/mcp-code-intelligence.rb | grep -E '(version|sha256)'
```
...
- Check: https://pypi.org/project/mcp-code-intelligence/
