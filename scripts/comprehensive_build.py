#!/usr/bin/env python3
"""Comprehensive build script for MCP Code Intelligence."""
...
class BuildManager:
    ...
    def __init__(self, project_root: Path):
        ...
        self.src_dir = project_root / "src" / "mcp_code_intelligence"
    ...
    def run_integration_tests(self) -> bool:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            commands = [
                ...
                (["mcp-code-intelligence", "--version"], "Testing CLI availability"),
            ]
            ...
            try:
                ...
                if not self.run_command(
                    ["mcp-code-intelligence", "index"], "Testing indexing"
                ):
                    return False

                search_cmd = ["mcp-code-intelligence", "search", "function", "--limit", "5"]
...
def main():
    ...
    print("🚀 MCP Code Intelligence - Comprehensive Build")
    print("=" * 50)
