...
# Get current version
CURRENT_VERSION=$(python -c "import sys; sys.path.insert(0, 'src'); from mcp_code_intelligence import __version__; print(__version__)")
...
echo "   2. Test installation: pip install mcp-code-intelligence==$CURRENT_VERSION"
