...
Default ChromaDB location: .mcp-code-intelligence/chromadb
"""
...
def get_default_persist_dir() -> Path:
    ...
    return Path.cwd() / ".mcp-code-intelligence" / "chromadb"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="ChromaDB persist directory (default: .mcp-code-intelligence/chromadb)",
    )
    parser.add_argument(
        "--collection",
        type=str,
