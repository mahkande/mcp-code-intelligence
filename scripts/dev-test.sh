...
echo "🧪 Running tests..."
uv run pytest -v --cov=src/mcp_code_intelligence || {
...
uv run mcp-code-intelligence --help > /dev/null || {
...
echo ""
echo "🎯 Next steps:"
echo "   1. Test your changes manually with: uv run mcp-code-intelligence"
