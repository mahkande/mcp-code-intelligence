...
End-to-end guide for releasing a new version of `mcp-code-intelligence` and updating the Homebrew formula.
...
# Output:
# MCP Code Intelligence Version Information
#   Version: 0.12.8
#   Build:   57
...
# Output:
# Successfully built mcp_code_intelligence-0.12.9.tar.gz and mcp_code_intelligence-0.12.9-py3-none-any.whl

# Verify contents
tar -tzf dist/mcp_code_intelligence-0.12.9.tar.gz | head -20
```
...
# Verify on TestPyPI
open https://test.pypi.org/project/mcp-code-intelligence/
...
# Uploading mcp_code_intelligence-0.12.9-py3-none-any.whl
# Uploading mcp_code_intelligence-0.12.9.tar.gz
# View at: https://pypi.org/project/mcp-code-intelligence/0.12.9/
```
...
# [DRY RUN] ℹ Updating formula: mcp-code-intelligence.rb
...
# Install new version
brew install bobmatnyc/mcp-code-intelligence/mcp-code-intelligence

# Verify installation
mcp-code-intelligence --version
# Output: mcp-code-intelligence version 0.12.9 (build 58)
...
echo
if [[ $REPLY =~ ^[Yy]$ ]]; then
  brew uninstall mcp-code-intelligence || true
  brew install bobmatnyc/mcp-code-intelligence/mcp-code-intelligence
  mcp-code-intelligence --version
...
echo "PyPI: https://pypi.org/project/mcp-code-intelligence/$NEW_VERSION/"
echo "GitHub: https://github.com/bobmatnyc/mcp-code-intelligence/releases/tag/v$NEW_VERSION"
echo ""
```
...
- [ ] PyPI package visible: https://pypi.org/project/mcp-code-intelligence/
- [ ] Homebrew formula updated: https://github.com/bobmatnyc/homebrew-mcp-code-intelligence
- [ ] `brew install` works
- [ ] `mcp-code-intelligence --version` shows correct version
...
# Visit: https://pypi.org/manage/project/mcp-code-intelligence/release/0.12.9/
...
```bash
# Clone tap repo
cd ~/.homebrew_tap_update/homebrew-mcp-code-intelligence
...
# Or manual edit
vim Formula/mcp-code-intelligence.rb
...
curl -I https://pypi.org/project/mcp-code-intelligence/

# Manually verify hash
wget https://files.pythonhosted.org/packages/.../mcp_code_intelligence-0.12.9.tar.gz
shasum -a 256 mcp_code_intelligence-0.12.9.tar.gz
...
# Debug installation
brew install --verbose --debug bobmatnyc/mcp-code-intelligence/mcp-code-intelligence

# Check logs
cat ~/Library/Logs/Homebrew/mcp-code-intelligence/*.log
```
...
3. Open issue: https://github.com/bobmatnyc/mcp-code-intelligence/issues
