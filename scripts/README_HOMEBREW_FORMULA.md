...
Comprehensive automation script for updating the Homebrew formula for `mcp-code-intelligence`.
...
| `HOMEBREW_TAP_REPO` | Custom tap repository URL | `https://github.com/bobmatnyc/homebrew-mcp-code-intelligence.git` |
...
- Uses configurable local path (default: `~/.homebrew_tap_update/homebrew-mcp-code-intelligence`)
...
→ Requesting: https://pypi.org/pypi/mcp-code-intelligence/json
[DRY RUN] ✓ Found version: 0.12.8
→ URL: https://files.pythonhosted.org/packages/.../mcp_code_intelligence-0.12.8.tar.gz
...
[DRY RUN] ℹ Cloning tap repository to ~/.homebrew_tap_update/homebrew-mcp-code-intelligence
→ Would clone from https://github.com/bobmatnyc/homebrew-mcp-code-intelligence.git
...
ℹ Tap repository exists at ~/.homebrew_tap_update/homebrew-mcp-code-intelligence
...
ℹ Users can now install with: brew install bobmatnyc/mcp-code-intelligence/mcp-code-intelligence
```
...
brew uninstall mcp-code-intelligence  # if previously installed
...
```
✗ Formula file not found: ~/.homebrew_tap_update/homebrew-mcp-code-intelligence/Formula/mcp-code-intelligence.rb
```
...
ls -la ~/.homebrew_tap_update/homebrew-mcp-code-intelligence/

# Clone manually first
git clone https://github.com/bobmatnyc/homebrew-mcp-code-intelligence.git ~/.homebrew_tap_update/homebrew-mcp-code-intelligence
...
curl https://pypi.org/pypi/mcp-code-intelligence/json | jq .
...
# Update to latest
cd ~/Projects/mcp-code-intelligence
./scripts/update_homebrew_formula.py
...
2. Open issue on GitHub: https://github.com/bobmatnyc/mcp-code-intelligence/issues
