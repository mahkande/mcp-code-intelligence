...
from ..output import console, print_info, print_success, print_tip
...
async def _run_batch_indexing(
    ...
    if show_progress:
        ...
        indexed_count = await indexer.index_project(
            force_reindex=force_reindex, show_progress=show_progress, skip_relationships=skip_relationships
        )
