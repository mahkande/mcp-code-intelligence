...
export function activate(context: vscode.ExtensionContext) {
  ...
  // This bridges the "Context Gap" by telling the AI which tools exist via system prompts.
  ...
  // Note: We NO LONGER start the server here. 
  // The MCP Server should be started by the MCP Client (e.g., VS Code Settings or Roo Code)
  // to ensure the proper STDIO transport layer is established with the LLM.
}
